...
Soon it will be scaled.
This is also made to train on txt files.
I will give the capacitie to train on html, json, txt, pdf, svg, and whatever else seems nice."""

""""Inputs is all you need."""
# hyperparameters
...
n = int(0.9*len(data))  #el primer 90% sera data de entrenamiento y el 10% de validacion.
train_data = data[:n]
val_data = data[n:]
